...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#0f1012" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#F2F4F5" };
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",      NULL };
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       "#21252B" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "#F2F4F5" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "CaskaydiaCoveNerdFontMono-14" };
...
static const keymap_t keys[] = {
	...
	{ 0,            XK_a,             i_fit_to_win,   		SCALE_FILL },
	{ 0,            XK_A,             i_toggle_alpha,       SCALE_FILL },
